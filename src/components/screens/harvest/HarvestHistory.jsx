  ...
  return (
    <div className="p-4 md:p-8 max-w-2xl mx-auto animate-in slide-in-from-right-10 duration-500">
      <div className="flex items-center gap-4 mb-8">
        <h2 className="text-2xl font-black text-slate-800">Histórico de Partidas</h2>
      </div>

      {history.length === 0 ? (
        <div className="bg-white rounded-3xl p-12 text-center shadow-md border border-slate-100">
          <div className="text-6xl mb-4">🌽</div>
          <h3 className="text-xl font-black text-slate-800 mb-2">Nenhuma partida ainda</h3>
          <p className="text-slate-500 text-sm">Suas colheitas competitivas aparecerão aqui!</p>
        </div>
      ) : (
            ...
            >
              <div className="flex justify-between items-start mb-3">
                ...
                <div className="text-right">
                  ...
                  <div className="text-[10px] font-bold text-slate-400 uppercase">Resultado Líquido</div>
                </div>
              </div>

              <div className="grid grid-cols-3 gap-2 bg-slate-50 p-2 rounded-xl">
                <div className="text-center">
                  <div className="text-[10px] font-black text-slate-400 uppercase">Sua Pontuação</div>
                ...
                <div className="text-center">
                  <div className="text-[10px] font-black text-slate-400 uppercase">Oponente</div>
